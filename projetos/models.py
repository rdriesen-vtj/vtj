...
class Icons(db.Model):
    ...
    etapa_id = db.Column(db.Integer, db.ForeignKey('etapas_table.id'))
...
class Etapas(db.Model):
    ...
    proj_id = db.Column(db.Integer, db.ForeignKey('projs_table.id'))
...
class Msgs(db.Model):
    ...
    timestamp = db.Column(db.DateTime, index=True, default=datetime.utcnow)
    tipo = db.Column(db.String(32))
    origin_id = db.Column(db.Integer, db.ForeignKey('users_table.id'))
...
class Users(UserMixin, db.Model):
    ...
    avatar_id = db.Column(db.Integer, db.ForeignKey('icons_table.id'))
...
class Orgs(UserMixin,db.Model):
    ...
    logo_id = db.Column(db.Integer, db.ForeignKey('icons_table.id'))
...
class Projs(UserMixin,db.Model):
    ...
    status = db.Column(db.String(32))
    responsavel_id = db.Column(db.Integer, db.ForeignKey('users_table.id'))
    icon_id = db.Column(db.Integer, db.ForeignKey('icons_table.id'))
    visibilidade = db.Column(db.String(32))
